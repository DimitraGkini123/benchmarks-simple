...
__attribute__((noinline, section(".injected_static"), used))
static void injected_never_called(void) {
    volatile uint32_t dummy = 0xDEADBEEF;
    dummy ^= 0x12345678;
    // Δεν καλείται ΠΟΥΘΕΝΑ στο πρόγραμμα
}
...
int main(void)
{
    ...
    printf("# FIRMWARE VARIANT: STATIC_INJECT\n");
    printf("\n===== LIGHT WORKLOADS =====\n\n");
